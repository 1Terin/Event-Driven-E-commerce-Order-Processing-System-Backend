...
or increase socketAcquisitionWarningTimeout=(millis) in the NodeHttpHandler config.`);
      ...
      async handle(request, { abortSignal, requestTimeout } = {}) {
        ...
        return new Promise((_resolve, _reject) => {
          ...
          writeRequestBodyPromise = writeRequestBody(req, request, effectiveRequestTimeout, this.externalAgent).catch((e4) => {
            timeouts.forEach(timing.clearTimeout);
            return _reject(e4);
          });
        });
...
var init_schemaSerializationMiddleware = __esm({
  "node_modules/@smithy/core/dist-es/submodules/schema/middleware/schemaSerializationMiddleware.js"() {
    ...
    schemaSerializationMiddleware = (config) => (next, context) => async (args) => {
      ...
      const request = await config.protocol.serializeRequest(operation(ns, n4, t4, i4, o4), args.input, {
        ...config,
        ...context,
        endpoint
      });
...
// node_modules/@aws-sdk/client-kinesis/dist-cjs/auth/httpAuthSchemeProvider.js
var require_httpAuthSchemeProvider = __commonJS({
  "node_modules/@aws-sdk/client-kinesis/dist-cjs/auth/httpAuthSchemeProvider.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.resolveHttpAuthSchemeConfig = exports2.defaultKinesisHttpAuthSchemeProvider = exports2.defaultKinesisHttpAuthSchemeParametersProvider = void 0;
    var core_1 = (init_dist_es2(), __toCommonJS(dist_es_exports2));
    var util_middleware_1 = require_dist_cjs6();
    var defaultKinesisHttpAuthSchemeParametersProvider = async (config, context, input) => {
      return {
    ...
    exports2.defaultKinesisHttpAuthSchemeParametersProvider = defaultKinesisHttpAuthSchemeParametersProvider;
    ...
    var defaultKinesisHttpAuthSchemeProvider = (authParameters) => {
      const options = [];
    ...
    exports2.defaultKinesisHttpAuthSchemeProvider = defaultKinesisHttpAuthSchemeProvider;
...
var require_package = __commonJS({
  "node_modules/@aws-sdk/client-kinesis/package.json"(exports2, module2) {
    module2.exports = {
      ...
      homepage: "https://github.com/aws/aws-sdk-js-v3/tree/main/clients/client-kinesis",
      repository: {
        type: "git",
...
var require_dist_cjs48 = __commonJS({
  "node_modules/@aws-sdk/client-sso/dist-cjs/index.js"(exports2) {
    ...
    var core = (init_dist_es(), __toCommonJS(dist_es_exports));
    var schema = (init_schema(), __toCommonJS(schema_exports));
    var middlewareContentLength = require_dist_cjs32();
    var middlewareEndpoint = require_dist_cjs35();
...
var init_runtimeConfig3 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/runtimeConfig.js"() {
    init_package();
    init_dist_es2();
    import_util_user_agent_node3 = __toESM(require_dist_cjs42());
    import_config_resolver5 = __toESM(require_dist_cjs30());
    init_dist_es();
    import_hash_node3 = __toESM(require_dist_cjs43());
    import_middleware_retry5 = __toESM(require_dist_cjs38());
    ...
    import_util_body_length_node3 = __toESM(require_dist_cjs44());
    import_util_defaults_mode_node3 = __toESM(require_dist_cjs45());
    import_util_retry3 = __toESM(require_dist_cjs37());
...
var init_STSClient = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/STSClient.js"() {
    ...
    init_dist_es();
    init_schema();
    import_middleware_content_length3 = __toESM(require_dist_cjs32());
    import_middleware_endpoint5 = __toESM(require_dist_cjs35());
    import_middleware_retry6 = __toESM(require_dist_cjs38());
...
var init_AssumeRoleCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commands/AssumeRoleCommand.js"() {
    import_middleware_endpoint6 = __toESM(require_dist_cjs35());
...
var init_AssumeRoleWithWebIdentityCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commands/AssumeRoleWithWebIdentityCommand.js"() {
    import_middleware_endpoint7 = __toESM(require_dist_cjs35());
    ...
    var resolveCredentialSource = (credentialSource, profileName, logger2) => {
      const sourceProvidersMap = {
        EcsContainer: async (options) => {
          const { fromHttp } = await Promise.resolve().then(() => __toESM(require_dist_cjs41()));
          const { fromContainerMetadata } = await Promise.resolve().then(() => __toESM(require_dist_cjs40()));
        ...
        Ec2InstanceMetadata: async (options) => {
          ...
          const { fromInstanceMetadata } = await Promise.resolve().then(() => __toESM(require_dist_cjs40()));
          return async () => fromInstanceMetadata(options)().then(setNamedProvider);
        },
        Environment: async (options) => {
          logger2?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
          const { fromEnv } = await Promise.resolve().then(() => __toESM(require_dist_cjs39()));
...
var require_dist_cjs54 = __commonJS({
  "node_modules/@aws-sdk/credential-provider-node/dist-cjs/index.js"(exports2) {
    "use strict";
    var credentialProviderEnv = require_dist_cjs39();
    var propertyProvider = require_dist_cjs23();
    var sharedIniFileLoader = require_dist_cjs33();
    var ENV_IMDS_DISABLED = "AWS_EC2_METADATA_DISABLED";
    var remoteProvider = async (init) => {
      const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await Promise.resolve().then(() => __toESM(require_dist_cjs40()));
...
var require_dist_cjs56 = __commonJS({
  "node_modules/@aws-crypto/util/node_modules/@smithy/util-buffer-from/dist-cjs/index.js"(exports2, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_is_array_buffer = require_dist_cjs55();
...
var require_dist_cjs57 = __commonJS({
  "node_modules/@aws-crypto/util/node_modules/@smithy/util-utf8/dist-cjs/index.js"(exports2, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_util_buffer_from = require_dist_cjs56();
...
var require_convertToBuffer = __commonJS({
  "node_modules/@aws-crypto/util/build/main/convertToBuffer.js"(exports2) {
    ...
    var util_utf8_1 = require_dist_cjs57();
...
var require_dist_cjs59 = __commonJS({
  "node_modules/@smithy/eventstream-serde-universal/dist-cjs/index.js"(exports2) {
    "use strict";
    var eventstreamCodec = require_dist_cjs58();
...
var require_dist_cjs60 = __commonJS({
  "node_modules/@smithy/eventstream-serde-node/dist-cjs/index.js"(exports2) {
    "use strict";
    var eventstreamSerdeUniversal = require_dist_cjs59();
    var stream = require("stream");
...
// node_modules/@aws-sdk/client-kinesis/dist-cjs/endpoint/ruleset.js
var require_ruleset2 = __commonJS({
  "node_modules/@aws-sdk/client-kinesis/dist-cjs/endpoint/ruleset.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.ruleSet = void 0;
    var H2 = "required";
    ...
    var d4 = "aws.parseArn";
    var e4 = "arn";
    var f4 = "booleanEquals";
    var g4 = "endpoint";
    var h4 = "tree";
    var i4 = "error";
    var j4 = { [H2]: false, [I2]: "string" };
    var k4 = { [H2]: true, "default": false, [I2]: "boolean" };
    var l4 = { [L]: "not", [M]: [{ [L]: b4, [M]: [{ [N]: "Endpoint" }] }] };
    var m4 = { [N]: "Endpoint" };
    var n4 = { [L]: b4, [M]: [{ [N]: "Region" }] };
    var o4 = { [L]: "aws.partition", [M]: [{ [N]: "Region" }], [O]: "PartitionResult" };
    var p4 = { [L]: "not", [M]: [{ [L]: c4, [M]: [{ [L]: "getAttr", [M]: [{ [N]: "PartitionResult" }, "name"] }, "aws-iso"] }] };
    var q4 = { [L]: "getAttr", [M]: [{ [N]: "PartitionResult" }, "name"] };
    var r4 = { [L]: "not", [M]: [{ [L]: c4, [M]: [q4, "aws-iso-b"] }] };
    var s4 = { [L]: "getAttr", [M]: [{ [N]: "PartitionResult" }, "supportsFIPS"] };
    var t4 = {};
    var u4 = { [i4]: "FIPS is enabled but this partition does not support FIPS", [I2]: i4 };
    var v4 = { [i4]: "DualStack is enabled but this partition does not support DualStack", [I2]: i4 };
    var w4 = { [i4]: "Invalid ARN: Failed to parse ARN.", [I2]: i4 };
    var x4 = { [L]: f4, [M]: [true, { [L]: "getAttr", [M]: [{ [N]: "PartitionResult" }, "supportsDualStack"] }] };
    var y2 = [{ [N]: "StreamARN" }];
    var z2 = [{ [L]: b4, [M]: [m4] }];
    var A2 = [{ [K]: [{ [L]: "isValidHostLabel", [M]: [{ [L]: "getAttr", [M]: [{ [N]: e4 }, "accountId"] }, false] }], [J2]: [{ [K]: [{ [L]: "isValidHostLabel", [M]: [{ [L]: "getAttr", [M]: [{ [N]: e4 }, "region"] }, false] }], [J2]: [{ [K]: [{ [L]: c4, [M]: [{ [L]: "getAttr", [M]: [{ [N]: e4 }, "service"] }, "kinesis"] }], [J2]: [{ [K]: [{ [L]: "getAttr", [M]: [{ [N]: e4 }, "resourceId[0]"], [O]: "arnType" }, { [L]: "not", [M]: [{ [L]: c4, [M]: [{ [N]: "arnType" }, ""] }] }], [J2]: [{ [K]: [{ [L]: c4, [M]: [{ [N]: "arnType" }, "stream"] }], [J2]: [{ [K]: [{ [L]: c4, [M]: [q4, "{arn#partition}"] }], [J2]: [{ [K]: [{ [L]: b4, [M]: [{ [N]: "OperationType" }] }], [J2]: [{ [K]: [{ [L]: f4, [M]: [{ [N]: "UseFIPS" }, true] }, { [L]: f4, [M]: [{ [N]: "UseDualStack" }, true] }], [J2]: [{ [K]: [{ [L]: f4, [M]: [s4, true] }], [J2]: [{ [K]: [{ [L]: f4, [M]: [{ [L]: "getAttr", [M]: [{ [N]: "PartitionResult" }, "supportsDualStack"] }, true] }], [J2]: [{ [g4]: { [P]: "https://{arn#accountId}.{OperationType}-kinesis-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", [Q]: {}, [R]: {} }, [I2]: g4 }], [I2]: h4 }, { [i4]: "DualStack is enabled, but this partition does not support DualStack.", [I2]: i4 }], [I2]: h4 }, { [i4]: "FIPS is enabled, but this partition does not support FIPS.", [I2]: i4 }], [I2]: h4 }, { [K]: [{ [L]: f4, [M]: [{ [N]: "UseFIPS" }, true] }], [J2]: [{ [K]: [{ [L]: f4, [M]: [s4, true] }], [J2]: [{ [g4]: { [P]: "https://{arn#accountId}.{OperationType}-kinesis-fips.{Region}.{PartitionResult#dnsSuffix}", [Q]: {}, [R]: {} }, [I2]: g4 }], [I2]: h4 }, u4], [I2]: h4 }, { [K]: [{ [L]: f4, [M]: [{ [N]: "UseDualStack" }, true] }], [J2]: [{ [K]: [{ [L]: f4, [M]: [{ [L]: "getAttr", [M]: [{ [N]: "PartitionResult" }, "supportsDualStack"] }, true] }], [J2]: [{ [g4]: { [P]: "https://{arn#accountId}.{OperationType}-kinesis.{Region}.{PartitionResult#dualStackDnsSuffix}", [Q]: {}, [R]: {} }, [I2]: g4 }], [I2]: h4 }, v4], [I2]: h4 }, { [g4]: { [P]: "https://{arn#accountId}.{OperationType}-kinesis.{Region}.{PartitionResult#dnsSuffix}", [Q]: {}, [R]: {} }, [I2]: g4 }], [I2]: h4 }, { [i4]: "Operation Type is not set. Please contact service team for resolution.", [I2]: i4 }], [I2]: h4 }, { [i4]: "Partition: {arn#partition} from ARN doesn't match with partition name: {PartitionResult#name}.", [I2]: i4 }], [I2]: h4 }, { [i4]: "Invalid ARN: Kinesis ARNs don't support `{arnType}` arn types.", [I2]: i4 }], [I2]: h4 }, { [i4]: "Invalid ARN: No ARN type specified", [I2]: i4 }], [I2]: h4 }, { [i4]: "Invalid ARN: The ARN was not for the Kinesis service, found: {arn#service}.", [I2]: i4 }], [I2]: h4 }, { [i4]: "Invalid ARN: Invalid region.", [I2]: i4 }], [I2]: h4 }, { [i4]: "Invalid ARN: Invalid account id.", [I2]: i4 }];
    var B2 = [{ [L]: f4, [M]: [{ [N]: "UseFIPS" }, true] }, { [L]: f4, [M]: [{ [N]: "UseDualStack" }, true] }];
    var C2 = [{ [L]: f4, [M]: [s4, true] }];
    var D2 = [{ [L]: f4, [M]: [{ [N]: "UseFIPS" }, true] }];
    var E2 = [{ [L]: f4, [M]: [{ [N]: "UseDualStack" }, true] }];
    var F2 = [{ [N]: "ConsumerARN" }];
    var G2 = [{ [N]: "ResourceARN" }];
    var _data4 = { version: "1.0", parameters: { Region: j4, UseDualStack: k4, UseFIPS: k4, Endpoint: j4, StreamARN: j4, OperationType: j4, ConsumerARN: j4, ResourceARN: j4 }, [J2]: [{ [K]: [{ [L]: b4, [M]: y2 }, l4, n4, o4, p4, r4], [J2]: [{ [K]: [{ [L]: d4, [M]: y2, [O]: e4 }], [J2]: A2, [I2]: h4 }, w4], [I2]: h4 }, { [K]: [{ [L]: b4, [M]: F2 }, l4, n4, o4, p4, r4], [J2]: [{ [K]: [{ [L]: d4, [M]: F2, [O]: e4 }], [J2]: A2, [I2]: h4 }, w4], [I2]: h4 }, { [K]: [{ [L]: b4, [M]: G2 }, l4, n4, o4, p4, r4], [J2]: [{ [K]: [{ [L]: d4, [M]: G2, [O]: e4 }], [J2]: A2, [I2]: h4 }, w4], [I2]: h4 }, { [K]: z2, [J2]: [{ [K]: D2, error: "Invalid Configuration: FIPS and custom endpoint are not supported", [I2]: i4 }, { [K]: E2, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", [I2]: i4 }, { endpoint: { [P]: m4, [Q]: t4, [R]: t4 }, [I2]: g4 }], [I2]: h4 }, { [K]: [n4], [J2]: [{ [K]: [o4], [J2]: [{ [K]: B2, [J2]: [{ [K]: [{ [L]: f4, [M]: [a4, s4] }, x4], [J2]: [{ endpoint: { [P]: "https://kinesis-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", [Q]: t4, [R]: t4 }, [I2]: g4 }], [I2]: h4 }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", [I2]: i4 }], [I2]: h4 }, { [K]: D2, [J2]: [{ [K]: C2, [J2]: [{ [K]: [{ [L]: c4, [M]: [q4, "aws-us-gov"] }], endpoint: { [P]: "https://kinesis.{Region}.amazonaws.com", [Q]: t4, [R]: t4 }, [I2]: g4 }, { endpoint: { [P]: "https://kinesis-fips.{Region}.{PartitionResult#dnsSuffix}", [Q]: t4, [R]: t4 }, [I2]: g4 }], [I2]: h4 }, u4], [I2]: h4 }, { [K]: E2, [J2]: [{ [K]: [x4], [J2]: [{ endpoint: { [P]: "https://kinesis.{Region}.{PartitionResult#dualStackDnsSuffix}", [Q]: t4, [R]: t4 }, [I2]: g4 }], [I2]: h4 }, v4], [I2]: h4 }, { endpoint: { [P]: "https://kinesis.{Region}.{PartitionResult#dnsSuffix}", [Q]: t4, [R]: t4 }, [I2]: g4 }], [I2]: h4 }], [I2]: h4 }, { error: "Invalid Configuration: Missing Region", [I2]: i4 }] };
    exports2.ruleSet = _data4;
  }
});

// node_modules/@aws-sdk/client-kinesis/dist-cjs/endpoint/endpointResolver.js
var require_endpointResolver2 = __commonJS({
  "node_modules/@aws-sdk/client-kinesis/dist-cjs/endpoint/endpointResolver.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.defaultEndpointResolver = void 0;
    var util_endpoints_1 = require_dist_cjs22();
...
// node_modules/@aws-sdk/client-kinesis/dist-cjs/runtimeConfig.shared.js
var require_runtimeConfig_shared2 = __commonJS({
  "node_modules/@aws-sdk/client-kinesis/dist-cjs/runtimeConfig.shared.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getRuntimeConfig = void 0;
    var core_1 = (init_dist_es2(), __toCommonJS(dist_es_exports2));
...
// node_modules/@aws-sdk/client-kinesis/dist-cjs/runtimeConfig.js
var require_runtimeConfig2 = __commonJS({
  "node_modules/@aws-sdk/client-kinesis/dist-cjs/runtimeConfig.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getRuntimeConfig = void 0;
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
...
// node_modules/@aws-sdk/client-kinesis/dist-cjs/index.js
var require_dist_cjs62 = __commonJS({
  "node_modules/@aws-sdk/client-kinesis/dist-cjs/index.js"(exports2) {
    "use strict";
    var middlewareHostHeader = require_dist_cjs3();
    var middlewareLogger = require_dist_cjs4();
    var middlewareRecursionDetection = require_dist_cjs5();
    ...
    var core = (init_dist_es(), __toCommonJS(dist_es_exports));
    var schema = (init_schema(), __toCommonJS(schema_exports));
    var eventstreamSerdeConfigResolver = require_dist_cjs31();
    var middlewareContentLength = require_dist_cjs32();
    var middlewareEndpoint = require_dist_cjs35();
    var middlewareRetry = require_dist_cjs38();
    var smithyClient = require_dist_cjs26();
    ...
    var regionConfigResolver = require_dist_cjs46();
    var protocolHttp = require_dist_cjs2();
    var utilWaiter = require_dist_cjs61();
    var resolveClientEndpointParameters4 = (options) => {
      return Object.assign(options, {
        useDualstackEndpoint: options.useDualstackEndpoint ?? false,
        useFipsEndpoint: options.useFipsEndpoint ?? false,
    ...
    var KinesisClient2 = class extends smithyClient.Client {
      config;
      constructor(...[configuration]) {
        const _config_0 = runtimeConfig.getRuntimeConfig(configuration || {});
        super(_config_0);
    ...
    var KinesisServiceException = class _KinesisServiceException extends smithyClient.ServiceException {
      constructor(options) {
        super(options);
        Object.setPrototypeOf(this, _KinesisServiceException.prototype);
      }
    };
    var AccessDeniedException3 = class _AccessDeniedException extends KinesisServiceException {
      name = "AccessDeniedException";
      $fault = "client";
      constructor(opts) {
        super({
    ...
    var ValidationException2 = class _ValidationException extends KinesisServiceException {
      name = "ValidationException";
      $fault = "client";
      constructor(opts) {
        super({
    ...
    var _AAT = "ApproximateArrivalTimestamp";
    var _ADE3 = "AccessDeniedException";
    var _APSI = "AdjacentParentShardId";
    var _ASTM = "AdjacentShardToMerge";
    var _ATTS = "AddTagsToStream";
    var _ATTSI = "AddTagsToStreamInput";
    var _C2 = "Consumer";
    var _CARN = "ConsumerARN";
    var _CC = "ConsumerCount";
    var _CCT = "ConsumerCreationTimestamp";
    var _CD = "ConsumerDescription";
    var _CL = "ConsumerList";
    var _CMB = "CurrentMiBps";
    var _CN = "ConsumerName";
    var _CS2 = "ChildShard";
    var _CSC = "CurrentShardCount";
    var _CSI = "CreateStreamInput";
    var _CSL = "ChildShardList";
    var _CSLM = "CurrentShardLevelMetrics";
    var _CSN = "ContinuationSequenceNumber";
    var _CSh = "ChildShards";
    var _CSo = "ConsumerStatus";
    var _CSr = "CreateStream";
    var _Co = "Consumers";
    var _D = "Data";
    var _DAS = "DescribeAccountSettings";
    var _DASI = "DescribeAccountSettingsInput";
    var _DASO = "DescribeAccountSettingsOutput";
    var _DEM = "DisableEnhancedMonitoring";
    var _DEMI = "DisableEnhancedMonitoringInput";
    ...
    var _DS2 = "DeleteStream";
    var _DSC = "DeregisterStreamConsumer";
    var _DSCI = "DeregisterStreamConsumerInput";
    var _DSCIe = "DescribeStreamConsumerInput";
    var _DSCO = "DescribeStreamConsumerOutput";
    var _DSCe = "DescribeStreamConsumer";
    var _DSI = "DeleteStreamInput";
    var _DSIe = "DescribeStreamInput";
    var _DSLM = "DesiredShardLevelMetrics";
    var _DSO = "DescribeStreamOutput";
    var _DSRP = "DecreaseStreamRetentionPeriod";
    var _DSRPI = "DecreaseStreamRetentionPeriodInput";
    var _DSS = "DescribeStreamSummary";
    var _DSSI = "DescribeStreamSummaryInput";
    var _DSSO = "DescribeStreamSummaryOutput";
    var _DSe = "DescribeStream";
    var _EA = "EndedAt";
    var _EAEA = "EarliestAllowedEndAt";
    var _EC = "ErrorCode";
    var _ECD = "EnforceConsumerDeletion";
    var _EEM = "EnableEnhancedMonitoring";
    var _EEMI = "EnableEnhancedMonitoringInput";
    var _EHK = "EndingHashKey";
    var _EHKx = "ExplicitHashKey";
    var _EIE = "ExpiredIteratorException";
    var _EM = "EnhancedMetrics";
    var _EML = "EnhancedMonitoringList";
    var _EMO = "EnhancedMonitoringOutput";
    var _EMn = "EnhancedMonitoring";
    var _EMr = "ErrorMessage";
    var _ENTE = "ExpiredNextTokenException";
    var _ES = "EventStream";
    var _ESN = "EndingSequenceNumber";
    var _ESSI = "ExclusiveStartShardId";
    var _ESSN = "ExclusiveStartStreamName";
    var _ESTK = "ExclusiveStartTagKey";
    var _ET = "EncryptionType";
    var _FRC = "FailedRecordCount";
    var _GR = "GetRecords";
    var _GRI = "GetRecordsInput";
    var _GRO = "GetRecordsOutput";
    var _GRP = "GetResourcePolicy";
    var _GRPI = "GetResourcePolicyInput";
    var _GRPO = "GetResourcePolicyOutput";
    var _GSI = "GetShardIterator";
    var _GSII = "GetShardIteratorInput";
    var _GSIO = "GetShardIteratorOutput";
    var _HKR = "HashKeyRange";
    var _HMS = "HasMoreStreams";
    var _HMSa = "HasMoreShards";
    var _HMT = "HasMoreTags";
    var _IAE = "InvalidArgumentException";
    var _IFE = "InternalFailureException";
    var _ISRP = "IncreaseStreamRetentionPeriod";
    var _ISRPI = "IncreaseStreamRetentionPeriodInput";
    var _K2 = "Key";
    var _KI = "KeyId";
    ...
    var _KMSOIR = "KMSOptInRequired";
    var _KMSTE = "KMSThrottlingException";
    var _L = "Limit";
    var _LEE = "LimitExceededException";
    var _LS = "ListShards";
    var _LSC = "ListStreamConsumers";
    var _LSCI = "ListStreamConsumersInput";
    var _LSCO = "ListStreamConsumersOutput";
    var _LSI = "ListShardsInput";
    var _LSIi = "ListStreamsInput";
    var _LSO = "ListShardsOutput";
    var _LSOi = "ListStreamsOutput";
    var _LSi = "ListStreams";
    var _LTFR = "ListTagsForResource";
    var _LTFRI = "ListTagsForResourceInput";
    var _LTFRO = "ListTagsForResourceOutput";
    var _LTFS = "ListTagsForStream";
    var _LTFSI = "ListTagsForStreamInput";
    var _LTFSO = "ListTagsForStreamOutput";
    var _MBL = "MillisBehindLatest";
    var _MR = "MaxResults";
    var _MRSIKB = "MaxRecordSizeInKiB";
    var _MS = "MergeShards";
    var _MSI = "MergeShardsInput";
    var _MTBC = "MinimumThroughputBillingCommitment";
    var _MTBCI = "MinimumThroughputBillingCommitmentInput";
    var _MTBCO = "MinimumThroughputBillingCommitmentOutput";
    var _NSHK = "NewStartingHashKey";
    var _NSI = "NextShardIterator";
    var _NT = "NextToken";
    var _ODSC = "OnDemandStreamCount";
    var _ODSCL = "OnDemandStreamCountLimit";
    var _OSC = "OpenShardCount";
    var _P2 = "Policy";
    var _PK = "PartitionKey";
    var _PR = "PutRecord";
    var _PRI = "PutRecordInput";
    var _PRIu = "PutRecordsInput";
    var _PRO = "PutRecordOutput";
    var _PROu = "PutRecordsOutput";
    var _PRP = "PutResourcePolicy";
    var _PRPI = "PutResourcePolicyInput";
    var _PRRE = "PutRecordsRequestEntry";
    var _PRREL = "PutRecordsRequestEntryList";
    var _PRRELu = "PutRecordsResultEntryList";
    var _PRREu = "PutRecordsResultEntry";
    var _PRu = "PutRecords";
    var _PS = "ParentShards";
    var _PSI = "ParentShardId";
    ...
    var _RL = "RecordList";
    var _RNFE = "ResourceNotFoundException";
    var _RPH = "RetentionPeriodHours";
    var _RSC = "RegisterStreamConsumer";
    var _RSCI = "RegisterStreamConsumerInput";
    var _RSCO = "RegisterStreamConsumerOutput";
    var _RTFS = "RemoveTagsFromStream";
    var _RTFSI = "RemoveTagsFromStreamInput";
    var _Re = "Record";
    var _S = "Shards";
    var _SA = "StartedAt";
    var _SARN = "StreamARN";
    var _SC = "ShardCount";
    var _SCT = "StreamCreationTimestamp";
    var _SD = "StreamDescription";
    var _SDS = "StreamDescriptionSummary";
    var _SF = "ShardFilter";
    var _SHK = "StartingHashKey";
    var _SI2 = "ShardId";
    var _SIT = "ShardIteratorType";
    var _SIh = "ShardIterator";
    var _SL = "ShardLimit";
    var _SLM = "ShardLevelMetrics";
    var _SLh = "ShardList";
    var _SM = "StreamMode";
    var _SMD = "StreamModeDetails";
    var _SN2 = "StreamName";
    var _SNFO = "SequenceNumberForOrdering";
    var _SNR = "SequenceNumberRange";
    var _SNe = "SequenceNumber";
    var _SNt = "StreamNames";
    var _SP = "StartingPosition";
    var _SS = "StreamSummaries";
    var _SSE = "StartStreamEncryption";
    var _SSEI = "StartStreamEncryptionInput";
    var _SSEIt = "StopStreamEncryptionInput";
    var _SSEt = "StopStreamEncryption";
    var _SSI = "SplitShardInput";
    var _SSL = "StreamSummaryList";
    var _SSN = "StartingSequenceNumber";
    var _SSp = "SplitShard";
    var _SSt = "StreamStatus";
    var _SStr = "StreamSummary";
    var _ST2 = "ScalingType";
    var _STM = "ShardToMerge";
    var _STS = "ShardToSplit";
    var _STSE = "SubscribeToShardEvent";
    var _STSES = "SubscribeToShardEventStream";
    var _STSI = "SubscribeToShardInput";
    var _STSO = "SubscribeToShardOutput";
    var _STSu = "SubscribeToShard";
    var _Sh = "Shard";
    var _St = "Status";
    var _T2 = "Tags";
    var _TK = "TagKeys";
    var _TL = "TagList";
    var _TMB = "TargetMiBps";
    var _TR = "TagResource";
    var _TRI = "TagResourceInput";
    var _TSC = "TargetShardCount";
    var _Ta2 = "Tag";
    var _Ti = "Timestamp";
    var _Ty = "Type";
    var _UAS = "UpdateAccountSettings";
    var _UASI = "UpdateAccountSettingsInput";
    var _UASO = "UpdateAccountSettingsOutput";
    var _UMRS = "UpdateMaxRecordSize";
    var _UMRSI = "UpdateMaxRecordSizeInput";
    var _UR = "UntagResource";
    var _URI = "UntagResourceInput";
    var _USC = "UpdateShardCount";
    var _USCI = "UpdateShardCountInput";
    var _USCO = "UpdateShardCountOutput";
    var _USM = "UpdateStreamMode";
    var _USMI = "UpdateStreamModeInput";
    var _USWT = "UpdateStreamWarmThroughput";
    var _USWTI = "UpdateStreamWarmThroughputInput";
    var _USWTO = "UpdateStreamWarmThroughputOutput";
    var _V2 = "Value";
    var _VE2 = "ValidationException";
    var _WT = "WarmThroughput";
    var _WTMB = "WarmThroughputMiBps";
    var _WTO = "WarmThroughputObject";
    var _c4 = "client";
    var _e4 = "error";
    var _m3 = "message";
    var _s4 = "server";
    var _sm3 = "smithy.ts.sdk.synthetic.com.amazonaws.kinesis";
    var _st = "streaming";
    var n04 = "com.amazonaws.kinesis";
    ...
    schema.TypeRegistry.for(n04).registerError(AccessDeniedException$3, AccessDeniedException3);
    ...
    var CreateStreamInput$ = [
      ...
      _CSI,
      0,
      [_SN2, _SC, _SMD, _T2, _WTMB, _MRSIKB],
    ...
    var DescribeAccountSettingsInput$ = [
      3,
      n04,
      _DASI,
      0,
    ...
    schema.TypeRegistry.for(n04).registerError(ExpiredIteratorException$, ExpiredIteratorException);
    ...
    schema.TypeRegistry.for(n04).registerError(ExpiredNextTokenException$, ExpiredNextTokenException);
    var GetRecordsInput$ = [
      3,
      n04,
      _GRI,
    ...
    schema.TypeRegistry.for(n04).registerError(InternalFailureException$, InternalFailureException);
    ...
    schema.TypeRegistry.for(n04).registerError(InvalidArgumentException$, InvalidArgumentException);
    ...
    schema.TypeRegistry.for(n04).registerError(KMSAccessDeniedException$, KMSAccessDeniedException);
    ...
    schema.TypeRegistry.for(n04).registerError(KMSDisabledException$, KMSDisabledException);
    ...
    schema.TypeRegistry.for(n04).registerError(KMSInvalidStateException$, KMSInvalidStateException);
    ...
    schema.TypeRegistry.for(n04).registerError(KMSNotFoundException$, KMSNotFoundException);
    ...
    schema.TypeRegistry.for(n04).registerError(KMSOptInRequired$, KMSOptInRequired);
    ...
    schema.TypeRegistry.for(n04).registerError(KMSThrottlingException$, KMSThrottlingException);
    ...
    schema.TypeRegistry.for(n04).registerError(LimitExceededException$, LimitExceededException);
    var ListShardsInput$ = [
      3,
      n04,
      _LSI,
      0,
      [_SN2, _NT, _ESSI, _MR, _SCT, _SF, _SARN],
    ...
    var MergeShardsInput$ = [
      ...
      _MSI,
      0,
      [_SN2, _STM, _ASTM, _SARN],
      [0, 0, 0, 0]
    ];
    var MinimumThroughputBillingCommitmentInput$ = [
      3,
      n04,
      _MTBCI,
      0,
    ...
    schema.TypeRegistry.for(n04).registerError(ProvisionedThroughputExceededException$, ProvisionedThroughputExceededException);
    var PutRecordInput$ = [
      3,
      n04,
      _PRI,
      0,
      [_SN2, _D, _PK, _EHKx, _SNFO, _SARN],
      [0, 21, 0, 0, 0, 0]
    ];
    var PutRecordOutput$ = [
      3,
    ...
    schema.TypeRegistry.for(n04).registerError(ResourceInUseException$, ResourceInUseException);
    var ResourceNotFoundException$ = [
      -3,
      n04,
      _RNFE,
    ...
    var StreamDescription$ = [
      ...
      _SD,
      0,
      [_SN2, _SARN, _SSt, _SMD, _S, _HMSa, _RPH, _SCT, _EMn, _ET, _KI],
    ...
    var StreamDescriptionSummary$ = [
      ...
      _SDS,
      0,
      [_SN2, _SARN, _SSt, _SMD, _RPH, _SCT, _EMn, _ET, _KI, _OSC, _CC, _WT, _MRSIKB],
    ...
    var UpdateStreamWarmThroughputInput$ = [
      3,
      n04,
      _USWTI,
      0,
    ...
    schema.TypeRegistry.for(n04).registerError(ValidationException$2, ValidationException2);
    var WarmThroughputObject$ = [
      3,
      n04,
      _WTO,
      0,
    ...
    var __Unit = "unit";
    var KinesisServiceException$ = [-3, _sm3, "KinesisServiceException", 0, [], []];
    schema.TypeRegistry.for(_sm3).registerError(KinesisServiceException$, KinesisServiceException);
    var ChildShardList = [
      1,
      n04,
      _CSL,
    ...
    var PutRecordsRequestEntryList = [
      1,
      n04,
      _PRREL,
      0,
    ...
    var AddTagsToStreamCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "AddTagsToStream", {}).n("KinesisClient", "AddTagsToStreamCommand").sc(AddTagsToStream$).build() {
    };
    var CreateStreamCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "CreateStream", {}).n("KinesisClient", "CreateStreamCommand").sc(CreateStream$).build() {
    };
    var DecreaseStreamRetentionPeriodCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "DecreaseStreamRetentionPeriod", {}).n("KinesisClient", "DecreaseStreamRetentionPeriodCommand").sc(DecreaseStreamRetentionPeriod$).build() {
    };
    var DeleteResourcePolicyCommand = class extends smithyClient.Command.classBuilder().ep({
      ...
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "DeleteResourcePolicy", {}).n("KinesisClient", "DeleteResourcePolicyCommand").sc(DeleteResourcePolicy$).build() {
    };
    var DeleteStreamCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "DeleteStream", {}).n("KinesisClient", "DeleteStreamCommand").sc(DeleteStream$).build() {
    };
    var DeregisterStreamConsumerCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      ...
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "DeregisterStreamConsumer", {}).n("KinesisClient", "DeregisterStreamConsumerCommand").sc(DeregisterStreamConsumer$).build() {
    };
    var DescribeAccountSettingsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "DescribeAccountSettings", {}).n("KinesisClient", "DescribeAccountSettingsCommand").sc(DescribeAccountSettings$).build() {
    };
    var DescribeLimitsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "DescribeLimits", {}).n("KinesisClient", "DescribeLimitsCommand").sc(DescribeLimits$).build() {
    };
    var DescribeStreamCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "DescribeStream", {}).n("KinesisClient", "DescribeStreamCommand").sc(DescribeStream$).build() {
    };
    var DescribeStreamConsumerCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      ConsumerARN: { type: "contextParams", name: "ConsumerARN" },
      StreamARN: { type: "contextParams", name: "StreamARN" }
      ...
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "DescribeStreamConsumer", {}).n("KinesisClient", "DescribeStreamConsumerCommand").sc(DescribeStreamConsumer$).build() {
    };
    var DescribeStreamSummaryCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "DescribeStreamSummary", {}).n("KinesisClient", "DescribeStreamSummaryCommand").sc(DescribeStreamSummary$).build() {
    };
    var DisableEnhancedMonitoringCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "DisableEnhancedMonitoring", {}).n("KinesisClient", "DisableEnhancedMonitoringCommand").sc(DisableEnhancedMonitoring$).build() {
    };
    var EnableEnhancedMonitoringCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "EnableEnhancedMonitoring", {}).n("KinesisClient", "EnableEnhancedMonitoringCommand").sc(EnableEnhancedMonitoring$).build() {
    };
    var GetRecordsCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `data` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "GetRecords", {}).n("KinesisClient", "GetRecordsCommand").sc(GetRecords$).build() {
    };
    var GetResourcePolicyCommand = class extends smithyClient.Command.classBuilder().ep({
      ...
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "GetResourcePolicy", {}).n("KinesisClient", "GetResourcePolicyCommand").sc(GetResourcePolicy$).build() {
    };
    var GetShardIteratorCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `data` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "GetShardIterator", {}).n("KinesisClient", "GetShardIteratorCommand").sc(GetShardIterator$).build() {
    };
    var IncreaseStreamRetentionPeriodCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "IncreaseStreamRetentionPeriod", {}).n("KinesisClient", "IncreaseStreamRetentionPeriodCommand").sc(IncreaseStreamRetentionPeriod$).build() {
    };
    var ListShardsCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "ListShards", {}).n("KinesisClient", "ListShardsCommand").sc(ListShards$).build() {
    };
    var ListStreamConsumersCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "ListStreamConsumers", {}).n("KinesisClient", "ListStreamConsumersCommand").sc(ListStreamConsumers$).build() {
    };
    var ListStreamsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "ListStreams", {}).n("KinesisClient", "ListStreamsCommand").sc(ListStreams$).build() {
    };
    var ListTagsForResourceCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      ResourceARN: { type: "contextParams", name: "ResourceARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "ListTagsForResource", {}).n("KinesisClient", "ListTagsForResourceCommand").sc(ListTagsForResource$).build() {
    };
    var ListTagsForStreamCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "ListTagsForStream", {}).n("KinesisClient", "ListTagsForStreamCommand").sc(ListTagsForStream$).build() {
    };
    var MergeShardsCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "MergeShards", {}).n("KinesisClient", "MergeShardsCommand").sc(MergeShards$).build() {
    };
    var PutRecordCommand2 = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `data` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "PutRecord", {}).n("KinesisClient", "PutRecordCommand").sc(PutRecord$).build() {
    };
    var PutRecordsCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `data` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "PutRecords", {}).n("KinesisClient", "PutRecordsCommand").sc(PutRecords$).build() {
    };
    var PutResourcePolicyCommand = class extends smithyClient.Command.classBuilder().ep({
      ...
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "PutResourcePolicy", {}).n("KinesisClient", "PutResourcePolicyCommand").sc(PutResourcePolicy$).build() {
    };
    var RegisterStreamConsumerCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "RegisterStreamConsumer", {}).n("KinesisClient", "RegisterStreamConsumerCommand").sc(RegisterStreamConsumer$).build() {
    };
    var RemoveTagsFromStreamCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "RemoveTagsFromStream", {}).n("KinesisClient", "RemoveTagsFromStreamCommand").sc(RemoveTagsFromStream$).build() {
    };
    var SplitShardCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "SplitShard", {}).n("KinesisClient", "SplitShardCommand").sc(SplitShard$).build() {
    };
    var StartStreamEncryptionCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "StartStreamEncryption", {}).n("KinesisClient", "StartStreamEncryptionCommand").sc(StartStreamEncryption$).build() {
    };
    var StopStreamEncryptionCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "StopStreamEncryption", {}).n("KinesisClient", "StopStreamEncryptionCommand").sc(StopStreamEncryption$).build() {
    };
    var SubscribeToShardCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `data` },
      ConsumerARN: { type: "contextParams", name: "ConsumerARN" }
    }).m(function(Command, cs, config, o4) {
    ...
    }).n("KinesisClient", "SubscribeToShardCommand").sc(SubscribeToShard$).build() {
    };
    var TagResourceCommand = class extends smithyClient.Command.classBuilder().ep({
      ...
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "TagResource", {}).n("KinesisClient", "TagResourceCommand").sc(TagResource$).build() {
    };
    var UntagResourceCommand = class extends smithyClient.Command.classBuilder().ep({
      ...
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "UntagResource", {}).n("KinesisClient", "UntagResourceCommand").sc(UntagResource$).build() {
    };
    var UpdateAccountSettingsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "UpdateAccountSettings", {}).n("KinesisClient", "UpdateAccountSettingsCommand").sc(UpdateAccountSettings$).build() {
    };
    var UpdateMaxRecordSizeCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "UpdateMaxRecordSize", {}).n("KinesisClient", "UpdateMaxRecordSizeCommand").sc(UpdateMaxRecordSize$).build() {
    };
    var UpdateShardCountCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "UpdateShardCount", {}).n("KinesisClient", "UpdateShardCountCommand").sc(UpdateShardCount$).build() {
    };
    var UpdateStreamModeCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "UpdateStreamMode", {}).n("KinesisClient", "UpdateStreamModeCommand").sc(UpdateStreamMode$).build() {
    };
    var UpdateStreamWarmThroughputCommand = class extends smithyClient.Command.classBuilder().ep({
      ...commonParams4,
      OperationType: { type: "staticContextParams", value: `control` },
      StreamARN: { type: "contextParams", name: "StreamARN" }
    }).m(function(Command, cs, config, o4) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Kinesis_20131202", "UpdateStreamWarmThroughput", {}).n("KinesisClient", "UpdateStreamWarmThroughputCommand").sc(UpdateStreamWarmThroughput$).build() {
    };
    var commands4 = {
      ...
      MergeShardsCommand,
      PutRecordCommand: PutRecordCommand2,
      PutRecordsCommand,
    ...
    var Kinesis = class extends KinesisClient2 {
    };
    smithyClient.createAggregatedClient(commands4, Kinesis);
    var paginateListStreamConsumers = core.createPaginator(KinesisClient2, ListStreamConsumersCommand, "NextToken", "NextToken", "MaxResults");
    var paginateListStreams = core.createPaginator(KinesisClient2, ListStreamsCommand, "NextToken", "NextToken", "Limit");
    ...
    var waitForStreamExists = async (params, input) => {
      const serviceDefaults = { minDelay: 10, maxDelay: 120 };
      return utilWaiter.createWaiter({ ...serviceDefaults, ...params }, input, checkState$1);
    };
    var waitUntilStreamExists = async (params, input) => {
      const serviceDefaults = { minDelay: 10, maxDelay: 120 };
    ...
    var waitForStreamNotExists = async (params, input) => {
      const serviceDefaults = { minDelay: 10, maxDelay: 120 };
      return utilWaiter.createWaiter({ ...serviceDefaults, ...params }, input, checkState);
    };
    var waitUntilStreamNotExists = async (params, input) => {
      const serviceDefaults = { minDelay: 10, maxDelay: 120 };
    ...
    var MinimumThroughputBillingCommitmentOutputStatus = {
      DISABLED: "DISABLED",
      ENABLED: "ENABLED",
    ...
    var MinimumThroughputBillingCommitmentInputStatus = {
      DISABLED: "DISABLED",
      ENABLED: "ENABLED"
    };
    var ScalingType = {
    ...
    exports2.AddTagsToStream$ = AddTagsToStream$;
    exports2.AddTagsToStreamCommand = AddTagsToStreamCommand;
    exports2.AddTagsToStreamInput$ = AddTagsToStreamInput$;
    exports2.ChildShard$ = ChildShard$;
    exports2.Consumer$ = Consumer$;
    exports2.ConsumerDescription$ = ConsumerDescription$;
    exports2.ConsumerStatus = ConsumerStatus;
    exports2.CreateStream$ = CreateStream$;
    exports2.CreateStreamCommand = CreateStreamCommand;
    exports2.CreateStreamInput$ = CreateStreamInput$;
    exports2.DecreaseStreamRetentionPeriod$ = DecreaseStreamRetentionPeriod$;
    exports2.DecreaseStreamRetentionPeriodCommand = DecreaseStreamRetentionPeriodCommand;
    exports2.DecreaseStreamRetentionPeriodInput$ = DecreaseStreamRetentionPeriodInput$;
    ...
    exports2.DeleteStream$ = DeleteStream$;
    exports2.DeleteStreamCommand = DeleteStreamCommand;
    exports2.DeleteStreamInput$ = DeleteStreamInput$;
    exports2.DeregisterStreamConsumer$ = DeregisterStreamConsumer$;
    exports2.DeregisterStreamConsumerCommand = DeregisterStreamConsumerCommand;
    exports2.DeregisterStreamConsumerInput$ = DeregisterStreamConsumerInput$;
    exports2.DescribeAccountSettings$ = DescribeAccountSettings$;
    exports2.DescribeAccountSettingsCommand = DescribeAccountSettingsCommand;
    exports2.DescribeAccountSettingsInput$ = DescribeAccountSettingsInput$;
    exports2.DescribeAccountSettingsOutput$ = DescribeAccountSettingsOutput$;
    ...
    exports2.DescribeStream$ = DescribeStream$;
    exports2.DescribeStreamCommand = DescribeStreamCommand;
    exports2.DescribeStreamConsumer$ = DescribeStreamConsumer$;
    exports2.DescribeStreamConsumerCommand = DescribeStreamConsumerCommand;
    exports2.DescribeStreamConsumerInput$ = DescribeStreamConsumerInput$;
    exports2.DescribeStreamConsumerOutput$ = DescribeStreamConsumerOutput$;
    exports2.DescribeStreamInput$ = DescribeStreamInput$;
    exports2.DescribeStreamOutput$ = DescribeStreamOutput$;
    exports2.DescribeStreamSummary$ = DescribeStreamSummary$;
    exports2.DescribeStreamSummaryCommand = DescribeStreamSummaryCommand;
    exports2.DescribeStreamSummaryInput$ = DescribeStreamSummaryInput$;
    exports2.DescribeStreamSummaryOutput$ = DescribeStreamSummaryOutput$;
    exports2.DisableEnhancedMonitoring$ = DisableEnhancedMonitoring$;
    exports2.DisableEnhancedMonitoringCommand = DisableEnhancedMonitoringCommand;
    exports2.DisableEnhancedMonitoringInput$ = DisableEnhancedMonitoringInput$;
    exports2.EnableEnhancedMonitoring$ = EnableEnhancedMonitoring$;
    exports2.EnableEnhancedMonitoringCommand = EnableEnhancedMonitoringCommand;
    exports2.EnableEnhancedMonitoringInput$ = EnableEnhancedMonitoringInput$;
    exports2.EncryptionType = EncryptionType;
    exports2.EnhancedMetrics$ = EnhancedMetrics$;
    exports2.EnhancedMonitoringOutput$ = EnhancedMonitoringOutput$;
    exports2.ExpiredIteratorException = ExpiredIteratorException;
    exports2.ExpiredIteratorException$ = ExpiredIteratorException$;
    exports2.ExpiredNextTokenException = ExpiredNextTokenException;
    exports2.ExpiredNextTokenException$ = ExpiredNextTokenException$;
    exports2.GetRecords$ = GetRecords$;
    exports2.GetRecordsCommand = GetRecordsCommand;
    exports2.GetRecordsInput$ = GetRecordsInput$;
    exports2.GetRecordsOutput$ = GetRecordsOutput$;
    ...
    exports2.GetShardIterator$ = GetShardIterator$;
    exports2.GetShardIteratorCommand = GetShardIteratorCommand;
    exports2.GetShardIteratorInput$ = GetShardIteratorInput$;
    exports2.GetShardIteratorOutput$ = GetShardIteratorOutput$;
    exports2.HashKeyRange$ = HashKeyRange$;
    exports2.IncreaseStreamRetentionPeriod$ = IncreaseStreamRetentionPeriod$;
    exports2.IncreaseStreamRetentionPeriodCommand = IncreaseStreamRetentionPeriodCommand;
    exports2.IncreaseStreamRetentionPeriodInput$ = IncreaseStreamRetentionPeriodInput$;
    ...
    exports2.KMSNotFoundException$ = KMSNotFoundException$;
    exports2.KMSOptInRequired = KMSOptInRequired;
    exports2.KMSOptInRequired$ = KMSOptInRequired$;
    exports2.KMSThrottlingException = KMSThrottlingException;
    exports2.KMSThrottlingException$ = KMSThrottlingException$;
    exports2.Kinesis = Kinesis;
    exports2.KinesisClient = KinesisClient2;
    exports2.KinesisServiceException = KinesisServiceException;
    exports2.KinesisServiceException$ = KinesisServiceException$;
    exports2.LimitExceededException = LimitExceededException;
    exports2.LimitExceededException$ = LimitExceededException$;
    exports2.ListShards$ = ListShards$;
    exports2.ListShardsCommand = ListShardsCommand;
    exports2.ListShardsInput$ = ListShardsInput$;
    exports2.ListShardsOutput$ = ListShardsOutput$;
    exports2.ListStreamConsumers$ = ListStreamConsumers$;
    exports2.ListStreamConsumersCommand = ListStreamConsumersCommand;
    exports2.ListStreamConsumersInput$ = ListStreamConsumersInput$;
    exports2.ListStreamConsumersOutput$ = ListStreamConsumersOutput$;
    exports2.ListStreams$ = ListStreams$;
    exports2.ListStreamsCommand = ListStreamsCommand;
    exports2.ListStreamsInput$ = ListStreamsInput$;
    exports2.ListStreamsOutput$ = ListStreamsOutput$;
    exports2.ListTagsForResource$ = ListTagsForResource$;
    exports2.ListTagsForResourceCommand = ListTagsForResourceCommand;
    exports2.ListTagsForResourceInput$ = ListTagsForResourceInput$;
    exports2.ListTagsForResourceOutput$ = ListTagsForResourceOutput$;
    exports2.ListTagsForStream$ = ListTagsForStream$;
    exports2.ListTagsForStreamCommand = ListTagsForStreamCommand;
    exports2.ListTagsForStreamInput$ = ListTagsForStreamInput$;
    exports2.ListTagsForStreamOutput$ = ListTagsForStreamOutput$;
    exports2.MergeShards$ = MergeShards$;
    exports2.MergeShardsCommand = MergeShardsCommand;
    exports2.MergeShardsInput$ = MergeShardsInput$;
    exports2.MetricsName = MetricsName;
    exports2.MinimumThroughputBillingCommitmentInput$ = MinimumThroughputBillingCommitmentInput$;
    exports2.MinimumThroughputBillingCommitmentInputStatus = MinimumThroughputBillingCommitmentInputStatus;
    exports2.MinimumThroughputBillingCommitmentOutput$ = MinimumThroughputBillingCommitmentOutput$;
    exports2.MinimumThroughputBillingCommitmentOutputStatus = MinimumThroughputBillingCommitmentOutputStatus;
    exports2.ProvisionedThroughputExceededException = ProvisionedThroughputExceededException;
    exports2.ProvisionedThroughputExceededException$ = ProvisionedThroughputExceededException$;
    exports2.PutRecord$ = PutRecord$;
    exports2.PutRecordCommand = PutRecordCommand2;
    exports2.PutRecordInput$ = PutRecordInput$;
    exports2.PutRecordOutput$ = PutRecordOutput$;
    exports2.PutRecords$ = PutRecords$;
    exports2.PutRecordsCommand = PutRecordsCommand;
    exports2.PutRecordsInput$ = PutRecordsInput$;
    exports2.PutRecordsOutput$ = PutRecordsOutput$;
    exports2.PutRecordsRequestEntry$ = PutRecordsRequestEntry$;
    exports2.PutRecordsResultEntry$ = PutRecordsResultEntry$;
    ...
    exports2.RegisterStreamConsumer$ = RegisterStreamConsumer$;
    exports2.RegisterStreamConsumerCommand = RegisterStreamConsumerCommand;
    exports2.RegisterStreamConsumerInput$ = RegisterStreamConsumerInput$;
    exports2.RegisterStreamConsumerOutput$ = RegisterStreamConsumerOutput$;
    exports2.RemoveTagsFromStream$ = RemoveTagsFromStream$;
    exports2.RemoveTagsFromStreamCommand = RemoveTagsFromStreamCommand;
    exports2.RemoveTagsFromStreamInput$ = RemoveTagsFromStreamInput$;
    exports2.ResourceInUseException = ResourceInUseException;
    exports2.ResourceInUseException$ = ResourceInUseException$;
    exports2.ResourceNotFoundException = ResourceNotFoundException;
    exports2.ResourceNotFoundException$ = ResourceNotFoundException$;
    exports2.ScalingType = ScalingType;
    exports2.SequenceNumberRange$ = SequenceNumberRange$;
    exports2.Shard$ = Shard$;
    exports2.ShardFilter$ = ShardFilter$;
    exports2.ShardFilterType = ShardFilterType;
    exports2.ShardIteratorType = ShardIteratorType;
    exports2.SplitShard$ = SplitShard$;
    exports2.SplitShardCommand = SplitShardCommand;
    exports2.SplitShardInput$ = SplitShardInput$;
    exports2.StartStreamEncryption$ = StartStreamEncryption$;
    exports2.StartStreamEncryptionCommand = StartStreamEncryptionCommand;
    exports2.StartStreamEncryptionInput$ = StartStreamEncryptionInput$;
    exports2.StartingPosition$ = StartingPosition$;
    exports2.StopStreamEncryption$ = StopStreamEncryption$;
    exports2.StopStreamEncryptionCommand = StopStreamEncryptionCommand;
    exports2.StopStreamEncryptionInput$ = StopStreamEncryptionInput$;
    exports2.StreamDescription$ = StreamDescription$;
    exports2.StreamDescriptionSummary$ = StreamDescriptionSummary$;
    exports2.StreamMode = StreamMode;
    exports2.StreamModeDetails$ = StreamModeDetails$;
    exports2.StreamStatus = StreamStatus;
    exports2.StreamSummary$ = StreamSummary$;
    exports2.SubscribeToShard$ = SubscribeToShard$;
    exports2.SubscribeToShardCommand = SubscribeToShardCommand;
    exports2.SubscribeToShardEvent$ = SubscribeToShardEvent$;
    exports2.SubscribeToShardEventStream$ = SubscribeToShardEventStream$;
    exports2.SubscribeToShardInput$ = SubscribeToShardInput$;
    exports2.SubscribeToShardOutput$ = SubscribeToShardOutput$;
    exports2.Tag$ = Tag$2;
    ...
    exports2.UpdateAccountSettings$ = UpdateAccountSettings$;
    exports2.UpdateAccountSettingsCommand = UpdateAccountSettingsCommand;
    exports2.UpdateAccountSettingsInput$ = UpdateAccountSettingsInput$;
    exports2.UpdateAccountSettingsOutput$ = UpdateAccountSettingsOutput$;
    exports2.UpdateMaxRecordSize$ = UpdateMaxRecordSize$;
    exports2.UpdateMaxRecordSizeCommand = UpdateMaxRecordSizeCommand;
    exports2.UpdateMaxRecordSizeInput$ = UpdateMaxRecordSizeInput$;
    exports2.UpdateShardCount$ = UpdateShardCount$;
    exports2.UpdateShardCountCommand = UpdateShardCountCommand;
    exports2.UpdateShardCountInput$ = UpdateShardCountInput$;
    exports2.UpdateShardCountOutput$ = UpdateShardCountOutput$;
    exports2.UpdateStreamMode$ = UpdateStreamMode$;
    exports2.UpdateStreamModeCommand = UpdateStreamModeCommand;
    exports2.UpdateStreamModeInput$ = UpdateStreamModeInput$;
    exports2.UpdateStreamWarmThroughput$ = UpdateStreamWarmThroughput$;
    exports2.UpdateStreamWarmThroughputCommand = UpdateStreamWarmThroughputCommand;
    exports2.UpdateStreamWarmThroughputInput$ = UpdateStreamWarmThroughputInput$;
    exports2.UpdateStreamWarmThroughputOutput$ = UpdateStreamWarmThroughputOutput$;
    exports2.ValidationException = ValidationException2;
    exports2.ValidationException$ = ValidationException$2;
    exports2.WarmThroughputObject$ = WarmThroughputObject$;
    exports2._Record$ = _Record$;
    exports2.paginateListStreamConsumers = paginateListStreamConsumers;
    exports2.paginateListStreams = paginateListStreams;
    exports2.waitForStreamExists = waitForStreamExists;
    exports2.waitForStreamNotExists = waitForStreamNotExists;
    exports2.waitUntilStreamExists = waitUntilStreamExists;
    exports2.waitUntilStreamNotExists = waitUntilStreamNotExists;
  }
});
...
var import_client_kinesis = __toESM(require_dist_cjs62());
